...
export default function SignUp() {
  ...
  async function onSubmit(e){
    ...
    try {
      ...
      await setDoc(doc(db, "users", user.uid), formDataCopy); // adding the user's data to db
       ...
       <div className="w-full md:w-[67%] lg:w-[40%] lg:ml-20">
         ...
         <input 
           ...
           <input 
            ...
            <button 
            className="w-full bg-blue-600 px-7 py-3 text-white text-sm font-medium uppercase 
